...
eval("/**\n * Convert array of 16 byte values to UUID string format of the form:\n * XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX\n */\nvar byteToHex = [];\nfor (var i = 0; i < 256; ++i) {\n  byteToHex[i] = (i + 0x100).toString(16).substr(1);\n}\n\nfunction bytesToUuid(buf, offset) {\n  var i = offset || 0;\n  var bth = byteToHex;\n  // join used to fix memory issue caused by concatenation: https://bugs.chromium.org/p/v8/issues/detail?id=3175#c4\n  return ([bth[buf[i++]], bth[buf[i++]], \n\tbth[buf[i++]], bth[buf[i++]], '-',\n\tbth[buf[i++]], bth[buf[i++]], '-',\n\tbth[buf[i++]], bth[buf[i++]], '-',\n\tbth[buf[i++]], bth[buf[i++]], '-',\n\tbth[buf[i++]], bth[buf[i++]],\n\tbth[buf[i++]], bth[buf[i++]],\n\tbth[buf[i++]], bth[buf[i++]]]).join('');\n}\n\nmodule.exports = bytesToUuid;\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./node_modules/uuid/lib/bytesToUuid.js\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var uuid_v4__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! uuid/v4 */ \"./node_modules/uuid/v4.js\");\n/* harmony import */ var uuid_v4__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(uuid_v4__WEBPACK_IMPORTED_MODULE_0__);\n\n\nconst $button = document.querySelector('button');\n\nconst handler = StripeCheckout.configure({\n  key: \"pk_live_7killufsFZrxh2gHVolQ62fK\",\n  image: 'https://stripe.com/img/documentation/checkout/marketplace.png',\n  locale: 'auto',\n  closed: function () {\n\n  },\n  token: function(token) {\n\n    fetch(`${\"https://netlify-lambda.netlify.com/.netlify/functions/\"}purchase`, {\n      method: 'POST',\n      body: JSON.stringify({\n        token,\n        amount,\n        idempotency_key: uuid_v4__WEBPACK_IMPORTED_MODULE_0___default()()\n      }),\n      headers: new Headers({\n        'Content-Type': 'application/json'\n      })\n    })\n    .then(res => res.json())\n    .catch(error => console.error(error))\n    .then(response => {\n\n\n    });\n  }\n});\n\n$button.addEventListener('click', () => {\n  // setTimeout(() => {\n  //   $button.innerHTML = 'Waiting for response...';\n  // }, 500);\n\n  if ($button.id = \"loops\"){\n    handler.open({\n      amount: 500,\n      name: 'Loops',\n      description: 'Buy Loops'\n    });\n  } else if ($button.id = \"tracks\"){\n    handler.open({\n      amount: 2000,\n      name: 'Tracks',\n      description: 'Tracks'\n    });\n  } else if ($button.id = \"stems\"){\n    handler.open({\n      amount: 5000,\n      name: 'Stems',\n      description: 'Stems'\n    });\n  }\n\n});\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./source/javascripts/all.js\n");
